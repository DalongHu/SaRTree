...
Please note that this is the early stage release version v1.2.2, so not all of the functions work well now and many parts of the codes run slowly and redundantly.
