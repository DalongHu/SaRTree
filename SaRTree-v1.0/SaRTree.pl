...
==============Options==============
	...
	-filter/-e [off/rec/multi/both/either] optional, filter out SNPs with low confidence, \"off\" indicates close this function;\"rec\" mode deletes SNPs covered by recombination regions ignroing recombinant SNPs' distribution;\"multi\" mode deletes SNPs presenting more than two types of bases;\"both\" mode deletes only SNPs fitting both feathers detected by \"rec\" and \"multi\" modes;\"either\"  mode deletes SNPs fitting all SNPs fitting either \"rec\" and \"multi\" modes. default \"both\"\n
